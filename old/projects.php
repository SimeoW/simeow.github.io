			...
			<div id="gallery">
				<script>
					<?php
						...
						$galleryLinks=array_slice(scandir("project"),2);
						$thumbnailImages=array_slice(scandir("project/thumbnail"),2);
						$galleryLinks=array_filter($galleryLinks,"isHTML");
						$thumbnailImages=array_filter($thumbnailImages,"isIMG");
						
						$galleryLinks=explode("~","project/".implode("~project/",$galleryLinks));
						$thumbnailImages=explode("~","project/thumbnail/".implode("~project/thumbnail/",$thumbnailImages));
