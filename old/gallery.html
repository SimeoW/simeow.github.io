...
<body class="blur">
			...
			<div id="gallery">
				<script>
					<?php
						...
						$galleryLinks=array_slice(scandir("old/art"),2);
						$thumbnailImages=array_slice(scandir("old/art/thumbnail"),2);
						...
						echo "var galleryLinks = [\n\t\t\t\t\t\t\"old/art/".implode("\",\n\t\t\t\t\t\t\"old/art/",$galleryLinks)."\"\n\t\t\t\t\t];\n";
						echo "\t\t\t\t\tvar thumbnailImages = [\n\t\t\t\t\t\t\"old/art/thumbnail/".implode("\",\n\t\t\t\t\t\t\"old/art/thumbnail/",$thumbnailImages)."\"\n\t\t\t\t\t];\n";
					?>
				</script>
			</div>
			<br>
	...
	<div class="hidden">
		<ul>
			...
			<li><a href="">Home</a></li>
			<li><a href="gallery.html" class="selected">Artwork</a></li>
