...
class BingPhoto
{
	 ...
	 */
	public function __construct($date = self::TODAY, $n = 1, $locale = 'en-US', $resolution = self::RESOLUTION_LOW)
	{
		$this->setArgs([
			'n' => $n,
			'date' => $date,
...
$bing = new BingPhoto(BingPhoto::TODAY, 8, 'en-US', BingPhoto::RESOLUTION_HIGH);
//$images = (new BingPhoto())->getImages();
$images = $bing->getImages();
$image = $images[array_rand($images)];
//$image = (new BingPhoto())->getImage();
$image=$image['url'];
//echo $image;
